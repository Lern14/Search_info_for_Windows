#_______________________________________________________________Для удалённого сбора информации

$coms = @(dc23,cd23,....)  #- Если нужно несколько ПК нужно подставить заполенную переменную вместо "DOMAINE NAME"

$cred = Get-Credential #- ввод пароля.

Invoke-Command -ComputerName DOMAINE NAME -Credential $cred -ScriptBlock #{ заключить весь скрипт в скобки }

#______________________________________________________HTMLcode
...
#______________________________________________________Условия скрипта
...
#______________________________________________________General
...
#_____________________________________________________Hotfix
...
#_____________________________________________________Logical Disks
        $MyReport += Get-CustomHeaderClose
...
#_____________________________________________________Network Configuration
        $MyReport += Get-CustomHeaderClose
...
#_____________________________________________________Software
        $MyReport += Get-CustomHeaderClose
...
#_____________________________________________________Local Shares
...
#______________________________________________________Printers
        $MyReport += Get-CustomHeaderClose
...
#______________________________________________________Services
        $MyReport += Get-CustomHeaderClose
...
#______________________________________________________Regional Settings
        $MyReport += Get-CustomHeaderClose
...
#______________________________________________________Event Log Settings
        $MyReport += Get-CustomHeaderClose
...
#______________________________________________________Event Log Errors
            $MyReport += Get-CustomHeaderClose
...
#______________________________________________________Event Log Warnings
            $MyReport += Get-CustomHeaderClose
...
#______________________________________________________WARNING Entries
...
#______________________________________________________Запись файла

    $Date = Get-Date

    #Пример пути "\\TestVM\Audit$\"
